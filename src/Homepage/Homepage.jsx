...
function Homepage() {
    return (
        <div className=''>
            <div id='Home' className="relative w-screen md:flex  items-center hidden ">
    ...
    ">
            ...
            <div className="relative w-screen h-[455px] md:hidden ">
                {/* Background Section */}
                <div className="bg-[#603913]  w-[300px] h-[280px] absolute top-0 left-0 z-0 "></div>

                {/* Image Section */}
                <div className="relative bottom-[85px] left-[40px]  w-[300px] h-[300px] rounded-xl overflow-hidden mt-34 ">
                    <img
                        src={image}
                        alt="Main Dish"
                        className="w-full h-full object-cover rounded-tr-[250px] rounded-tl-[250px]"
    ...
    ">
                    ...
                    <div className="block md:hidden">
                        <Lighttext text="Pride" fontSize="120px" />
                    </div>
